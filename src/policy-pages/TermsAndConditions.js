...
const TermsAndConditions = () => {
  return (
    <div className="container">
      ...
      <Typography paragraph={true}>Welcome to ephemori!</Typography>

      <Typography paragraph={true}>
        These terms and conditions outline the rules and regulations for the use
        of ephemori's Website, located at www.ephemori.com.
      </Typography>

      <Typography paragraph={true}>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use ephemori if you do not agree to take
      ...
      <Typography paragraph={true}>
        We employ the use of cookies. By accessing ephemori, you agreed to use
        cookies in agreement with the ephemori's Privacy Policy.
      </Typography>
      ...
      <Typography paragraph={true}>
        Unless otherwise stated, ephemori and/or its licensors own the
        intellectual property rights for all material on ephemori. All
        intellectual property rights are reserved. You may access this from
        ephemori for your own personal use subjected to restrictions set in
        these terms and conditions.
      </Typography>

      <Typography paragraph={true}>You must not:</Typography>
      <List>
        <ListItem>
          <ListItemText>Republish material from ephemori</ListItemText>
        </ListItem>
        <ListItem>
          <ListItemText>
            Sell, rent or sub-license material from ephemori
          </ListItemText>
        </ListItem>
        <ListItem>
          <ListItemText>
            Reproduce, duplicate or copy material from ephemori
          </ListItemText>
        </ListItem>
        <ListItem>
          <ListItemText>Redistribute content from ephemori</ListItemText>
        </ListItem>
      </List>
      ...
      <Typography paragraph={true}>
        ...
        ephemori does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of ephemori,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, ephemori shall not be liable
      ...
      <Typography paragraph={true}>
        ephemori reserves the right to monitor all Comments and to remove any
        Comments which can be considered inappropriate, offensive or causes
        breach of these Terms and Conditions.
      </Typography>

      <Typography paragraph={true}>You warrant and represent that:</Typography>
      ...
      <Typography paragraph={true}>
        You hereby grant ephemori a non-exclusive license to use, reproduce,
      ...
      <List>
        <ListItem>
          <ListItemText>Government agencies;</ListItemText>
        </ListItem>
        <ListItem>
          <ListItemText>Search engines;</ListItemText>
        </ListItem>
        <ListItem>
          <ListItemText>News organizations;</ListItemText>
        </ListItem>
        <ListItem>
          <ListItemText>
      ...
      <List>
        ...
        <ListItem>
          <ListItemText>dot.com community sites;</ListItemText>
        </ListItem>
        <ListItem>
          <ListItemText>
        ...
        <ListItem>
          <ListItemText>online directory distributors;</ListItemText>
        </ListItem>
        <ListItem>
          <ListItemText>internet portals;</ListItemText>
        </ListItem>
        <ListItem>
          <ListItemText>accounting, law and consulting firms; and</ListItemText>
        </ListItem>
        <ListItem>
          <ListItemText>
      ...
      <Typography paragraph={true}>
        ...
        the hyperlink compensates the absence of ephemori; and (d) the link is
      ...
      <Typography paragraph={true}>
        ...
        e-mail to ephemori. Please include your name, your organization name,
      ...
      <List>
        <ListItem>
          <ListItemText>By use of our corporate name; or</ListItemText>
        </ListItem>
        <ListItem>
          <ListItemText>
      ...
      <Typography paragraph={true}>
        No use of ephemori's logo or other artwork will be allowed for linking
