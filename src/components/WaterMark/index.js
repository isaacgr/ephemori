...
const waterMarkStyle =
  "position: absolute;left: 0;right: 0;top:0;bottom:0;opacity: 0.7;z-index: 9999;pointer-events: none;overflow: hidden;background-color: transparent;background-repeat: repeat;";
const noop = function () {};
...
class WaterMark extends React.Component {
  ...
  genRandomId = (prefix = "") => {
    return `${this.encrypt(prefix)}-${new Date().getTime()}-${Math.floor(
